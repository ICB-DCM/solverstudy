...
plt.savefig(os.path.join(DIR_FIGURES, "Integration_Algo_Main.pdf"))
plt.savefig(os.path.join(DIR_FIGURES, "Integration_Algo_Main.png"),
            dpi=300)
plt.savefig(os.path.join(DIR_FIGURES, "Integration_Algo_Main.eps"),
            dpi=300, format="eps")
